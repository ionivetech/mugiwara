#!/usr/bin/env bash
# Rollback map for mission "seamless-followup" — generated at closure.
# Human-executed. Review before running; mugiwara never runs this.
# Branch: feat/seamless-followup
...
git revert --no-edit \
  ee519b84b5fb7516b671b29c1ad03e9bf9edf468 \
  7d2c24694d8d720fd0929a9f7702cc187a37ad7e \
  4879af8d88d4cac4ff3595c995d9cf39f3316970 \
  750f60a0a28717934f8356efa6378d5ad2339dbe \
  4b83e7d08db2eaa6db49b2e41011e3f5f52a8145 \
...
#   .metrics/latest.json
#   .mugiwara/index.md
#   .mugiwara/missions/seamless-followup/continue.json
#   .mugiwara/missions/seamless-followup/decisions.md
#   .mugiwara/missions/seamless-followup/flows/01-execution.md
#   .mugiwara/missions/seamless-followup/flows/02-execution.md
#   .mugiwara/missions/seamless-followup/flows/03-execution.md
#   .mugiwara/missions/seamless-followup/flows/todos.md
#   .mugiwara/missions/seamless-followup/plan.md
#   .mugiwara/missions/seamless-followup/spec.md
#   .mugiwara/missions/seamless-followup/state.json
#   .mugiwara/missions/seamless-governors/plan.md
#   .mugiwara/missions/seamless-governors/pr-verdict.md
#   .mugiwara/missions/seamless-governors/provenance.md
#   .mugiwara/missions/seamless-governors/report.md
#   .mugiwara/missions/seamless-governors/rollback.sh
#   README.md
#   content/agents/brook-healing.md
#   content/agents/memory-keeper.md
#   content/agents/usopp-brainstorm.md
#   content/agents/zoro-execution.md
#   content/skills/mugiwara-brainstorm/SKILL.md
