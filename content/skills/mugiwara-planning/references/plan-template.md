...
Every plan records the pre-change baseline at Flow 0/2 — each wave gate compares against it, and a red baseline's defects are inherited, never blamed on the mission:
