...
4. Write the verdict and evidence to `.mugiwara/missions/<mission>/waves/06-closure.md`. Verdict and PR-material prose follow `_shared/references/prose-style.md`.
