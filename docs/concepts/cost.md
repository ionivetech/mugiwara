...
Measured: the catalog index holds 20 skills (**Current:** 4,656 chars). Pointer checks cover 322 pointers with 0 broken. Retrieval probes count 216 with 95.9% rank 1.
