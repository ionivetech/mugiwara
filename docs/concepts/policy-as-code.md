...
Policy pushes **up**, never down. A forced [lane](../concepts/lanes.md) can raise `standard → full`;
...
| gates [flow stage](../concepts/workflow.md) (crew) | `gates.require_human_approval` | listed in gate output; human sign-off required before ship |
