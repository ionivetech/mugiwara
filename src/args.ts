...
const VALUE_FLAGS: Record<string, string> = { '--project': 'project', '--target': 'target', '--stale': 'stale', '--backend': 'backend', '--mission': 'mission', '--to-team': 'toTeam', '--to-solo': 'toSolo', '--flow': 'flow', '--area': 'area', '--files': 'files', '--path': 'path', '--stale': 'stale' };
